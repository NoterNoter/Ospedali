...
export default function CardApprofondimento({approfondimento, className}: {approfondimento: any, className?: string}) {
  return (
    <Link href={approfondimento?.link || ''} className={`p-1 px-2 bg-blu text-white flex flex-col justify-between min-h-[400px]  border-r border-white last:border-r-0 ${className}`}>
    ...
    <div className="">
      <h4 className='text-md-2 leading-none font-medium text-white mb-2 pb-1 border-b border-white'>{approfondimento.titolo}</h4>
