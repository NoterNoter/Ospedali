...
export default function CardApprofondimentoImage({approfondimento, className}: {approfondimento: any, className?: string}) {
  return (
    <Link href={approfondimento.link} className={`p-1 bg-blu text-white flex flex-col   ${className}`}>
      <div className='uppercase font-semibold mt-1 text-white text-sm flex items-center justify-between pb-1 relative'>APPROFONDIMENTO
