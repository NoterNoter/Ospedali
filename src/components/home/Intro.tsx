    ...
    <section className="grid grid-cols-5 mt-[300px]">
      <div className="col-span-3 col-start-2 px-2 py-2 bg-gray border border-black border-b ">
        <motion.h3
          ...
          className="text-md font-medium mb-8 max-w-[600px] leading-tight"
        >
          {intro.occhiello}
        </motion.h3>
      </div>
      ...
      <div className="col-span-3 bg-gray  border-r p-2 flex flex-col justify-between">
        <TextReveal>
          <h1 className="text-lg font-semibold leading-none mb-10">
            {intro.titolo}
          </h1>
        </TextReveal>
        <div className="flex justify-between">
          <div className="text-sm text-black">
            DI <br />
            <strong>LORENZO BUONAROSA</strong>
          </div>
          <div className="text-sm text-black ">
            DESIGN DI <br />
            <strong>LUCA GORINI</strong>
          </div>
        </div>
      </div>
    </section>
